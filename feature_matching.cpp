// REF: https://github.com/PointCloudLibrary/pcl/blob/master/apps/src/feature_matching.cpp
...
, show_correspondences (false)
{
  ...
  *target_segmented_ = *target_;
  ...
  // Downsampling pointcloud for speed reasons
...
void ICCVTutorial<FeatureType>::determineFinalTransformation ()
{
  ...
  // registration->setMaximumIterations (50); // This was 1000 originally???
  cout << "..." << endl;
...
void ICCVTutorial<FeatureType>::reconstructSurface ()
{
  ...
  *merged += *target_segmented_;
  pcl::io::savePCDFileASCII ("source_registered_.pcd", *source_registered_);
  pcl::io::savePCDFileASCII ("source_registered_plus_target_segmented.pcd", *merged);
